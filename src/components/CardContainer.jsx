  ...
  return (
    <div className="grid-cols-2 lg:grid lg:min-h-screen lg:place-content-center">
      <section className="relative h-[240px] w-[375px]">
        <div className="card-back absolute right-6 top-8 w-64 drop-shadow-lg lg:-right-16 lg:top-60 lg:w-full">
        ...
        <div className="card-front  absolute -bottom-5 left-6 w-64 drop-shadow-lg lg:bottom-0 lg:left-0  lg:top-0 lg:w-full">
